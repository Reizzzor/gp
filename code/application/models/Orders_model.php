...
//разные GET
	...
	public function get_preorders($po_val = NULL, $mode = 'id', $strg = FALSE)
	{
		...
		return $this->db->order_by('id', 'DESC')->get('pre_orders')->result_array();
	}
	...
	public function get_next_soid()
	{
		...
		/*if($this->sln != $this->storage_ids('sln')) */$po_max = $this->db->where('sln_order_id RLIKE "^'.$prfx_reg.'[0-9]{1,5}$"', NULL, FALSE)->get_where('pre_orders', $where_arr)->result_array();
